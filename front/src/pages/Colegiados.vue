...
<q-page>
  <div class="row">
    <div class="col-12">
      <q-table :loading="loading" title="Colegiados" dense bordered flat :filter="search" :rows="users" :columns="userColumns" :rows-per-page-options="[0]">
        <template v-slot:top-right>
          <q-btn @click="userAdd" color="primary" icon="add_circle_outline" dense label="Agregar" no-caps />
          <q-input dense outlined v-model="search" label="Buscar" >
